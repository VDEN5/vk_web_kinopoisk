                    ...
                    <input
                        ...
                        onChange={(e) => {
                            const min = Math.min(
                                ...
                                selectedRating?.split('-')[1] || 10
                            );
                            onRatingChange(
                                `${min}-${selectedRating?.split('-')[1] || 10}`
                            );
                        }}
                    />
                    <input
                        ...
                        onChange={(e) => {
                            const max = Math.max(
                                Number(e.target.value),
                                selectedRating?.split('-')[0] || 0
                            );
                            onRatingChange(
                                `${selectedRating?.split('-')[0] || 0}-${max}`
                            );
                        }}
                    />
                </div>
                ...
                <div className="d-flex align-items-center gap-3">
                    <input
                        ...
                        onChange={(e) => {
                            const min = Math.min(
                                Number(e.target.value),
                                selectedYears?.split('-')[1] || 2025
                            );
                            onYearsChange(
                                `${min}-${selectedYears?.split('-')[1] || 2025}`
                            );
                        }}
                    />
                    <input
                        ...
                        onChange={(e) => {
                            const max = Math.max(
                                Number(e.target.value),
                                selectedYears?.split('-')[0] || 1990
                            );
                            onYearsChange(
                                `${selectedYears?.split('-')[0] || 1990}-${max}`
                            );
                        }}
                    />
                </div>
